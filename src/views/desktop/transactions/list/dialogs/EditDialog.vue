                                    ...
                                    <div v-if="transaction.type === TransactionType.Expense">
                                        <amount-input class="transaction-edit-amount font-weight-bold flex-grow-1"
                                            ...
                                            <template #append-inner>
                                                <div class="expense-currency-menu-activator" v-if="mode !== TransactionEditPageMode.View">
                                                    <v-menu v-model="expenseCurrencyMenuState" location="bottom end" max-height="420">
                                                        <template #activator="{ props }">
                                                            <v-tooltip :text="tt('Change Currency')">
                                                                <template v-slot:activator="{ props: tooltipProps }">
                                                                    <v-icon class="ms-2" :icon="mdiCurrencyUsd"
                                                                            :disabled="!canSwitchToForeignCurrency || loading || submitting"
                                                                            v-bind="{ ...props, ...tooltipProps }"></v-icon>
                                                                </template>
                                                            </v-tooltip>
                                                        </template>

                                                        <v-card class="expense-currency-menu">
                                                            <v-card-title class="pa-3 pb-0 bg-surface">
                                                                <v-text-field
                                                            ...
                                                            <v-list class="pt-0 expense-currency-menu-list">
                                                                <v-list-item v-for="item in filteredExpenseCurrencyPickerItems"
                                                                             ...
                                                                             @click="updateExpenseAmountCurrency(item.currencyCode)">
                                                                    <template #append>
...
.expense-currency-menu-activator {
    display: inline-flex;
    align-items: center;
}
