            ...
            >
                <template #title>
                    <div class="transaction-edit-amount-title" v-if="transaction.type === TransactionType.Expense">
                        <span>{{ getDisplayAmount(parseBigDecimal(editedExpenseAmount), transaction.hideAmount, expenseAmountDisplayCurrency) }}</span>
                    ...
                    <span v-else>{{ getDisplayAmount(parseBigDecimal(transaction.sourceAmount), transaction.hideAmount, sourceAccountCurrency) }}</span>
                </template>
